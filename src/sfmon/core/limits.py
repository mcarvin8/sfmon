...
salesforce_limits_descriptions = {
    ...
    "ContentDistBandwidthLimitMB": "Hourly bandwidth limit for content distribution in MB.",
    "ContentDistViewLimit": "Limit for content distribution views.",
    "ContentPublicationLimit": "Limit for content publication actions.",
    "CreateCustom": "Limit for creating custom objects, fields, and other custom metadata components.",
    ...
    "DailyAsyncApexElasticExecutions": "Daily limit for elastic (on-demand scaled) asynchronous Apex executions.",
    ...
    "DailyBulkApiRequests": "Daily limit on Bulk API requests.",
    ...
    "DailyMetadataRetrievesWithDependencies": "Daily limit for metadata retrieve calls that include dependencies.",
    ...
    "ExternalServicesActiveObjects": "Limit for active objects defined in External Services.",
    "ExternalServicesActiveOperations": "Limit for active operations defined in External Services.",
    "ExternalServicesObjectProperties": "Limit for object properties defined in External Services schemas.",
    "ExternalServicesObjects": "Limit for objects defined in External Services schemas.",
    "ExternalServicesOperations": "Limit for operations defined in External Services schemas.",
    "ExternalServicesRegistrations": "Limit for registered External Services.",
    ...
    "MaxContentDocumentsLimit": "Maximum number of content documents allowed.",
    "MonthlyEinsteinDiscoveryStoryCreation": "Monthly limit for Einstein Discovery story creation.",
    "MonthlyPlatformEvents": "Monthly limit for platform event message delivery.",
    ...
    "PlatformEventTriggersWithParallelProcessing": "Limit for platform event triggers using parallel processing.",
    ...
    "ScheduledFlowRunLimit": "Limit for scheduled Flow runs.",
    "ScheduledPathRunLimit": "Limit for scheduled path (Process Builder/Flow scheduled paths) runs.",
